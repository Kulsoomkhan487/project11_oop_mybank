...
class Bank {
    ...
    findCustomerByAccNumber(accNumber) {
    ...
    while (!exit) {
        ...
        switch (service.Select) {
            case "View Balance":
                ...
                let accountBalance = myBank.accounts.find((acc) => acc.accNumber == parseInt(resBalance.accountNumber));
                if (!accountBalance) {
            ...
            case "Cash Withdraw":
                ...
                let accountWithdraw = myBank.accounts.find((acc) => acc.accNumber == parseInt(resWithdraw.accountNumber));
                if (!accountWithdraw) {
                    console.log(chalk.bold.red("Invalid Account Number"));
                }
                else {
            ...
            case "Cash Deposit":
                ...
                let accountDeposit = myBank.accounts.find((acc) => acc.accNumber == parseInt(resDeposit.accountNumber));
                if (!accountDeposit) {
